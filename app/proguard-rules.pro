...
-keep class com.novamusic.app.models.PersistQueue { *; }
-keep class com.novamusic.app.models.PersistPlayerState { *; }
-keep class com.novamusic.app.models.QueueData { *; }
-keep class com.novamusic.app.models.QueueType { *; }
-keep class com.novamusic.app.playback.queues.** { *; }

...
package com.novamusic.app.together
...
sealed interface TogetherClientEvent {
    ...
    data class JoinDecision(
        val decision: com.novamusic.app.together.JoinDecision,
    ) : TogetherClientEvent
    ...
    data class HeartbeatPong(
        val pong: com.novamusic.app.together.HeartbeatPong,
                ...
                try {
                    while (true) {
                        ...
                        when (message) {
                            ...
                            is com.novamusic.app.together.JoinDecision -> {

...
import com.novamusic.app.extensions.*
...
import com.novamusic.app.kugou.KuGou
import com.novamusic.app.lastfm.LastFM
import com.novamusic.app.ui.player.CanvasArtworkPlaybackCache
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    private fun initializeDeferredAsync() {
        ...
        applicationScope.launch(Dispatchers.IO) {
            dataStore.credentialFlow(InnerTubeCookieKey)
                .collect { cookie ->
                    try {
    ...
    companion object {
        ...
        fun forgetAccount(context: Context) {
            // Clear the encrypted copy too, otherwise the Keystore-backed cookie
            // would survive a logout and the reactive credentialFlow (App.kt /
            // HomeViewModel) would keep reporting the account as signed in.
